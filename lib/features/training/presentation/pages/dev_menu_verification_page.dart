...
// import 'package:face_shape/features/training/presentation/pages/dev_menu_result.dart';
...
//                 context,
//                 MaterialPageRoute(
//                     builder: (context) => TrainPreprocessingPage()),
//               );
//               return false;
//             },
...
//                                         SizedBox(height: 5),
//                                         DataDetail(width, height,
//                                             trainingValues, testingValues),
//                                         SizedBox(height: 20),
//                                         ImagePreprocessDetail(width, height),
//                                         SizedBox(height: 20),
//                                         ModelParamsDetail(width, height)
//                                       ]))),
//                           SizedBox(height: 5),
//                         ]),
//                         DevNextButton(),
...
//             print(_isLoading);
//           });
//           doPreprocess().then((value) {}).catchError((error) {});
//         },
//       ),
//     );
//   }

//   Center ModelParamsDetail(double width, double height) {
//     return Center(
//       child: Container(
...
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
//                             CustomList2(preprocessing: results[0]),
//                             CustomList2(preprocessing: results[1]),
//                             CustomList2(preprocessing: results[2]),
//                           ]),
//                     )
//                   ]),
//             ),
...
//             children: [
//               TrainingDetail(width, height, trainingValues),
//               SizedBox(height: 15),
//               TestingDetail(width, height, testingValues)
//             ],
//           ),
//         ),
//       ),
